...
import static com.ivokarchev.tasktimer.AppProvider.CONTENT_AUTHORITY;
import static com.ivokarchev.tasktimer.AppProvider.CONTENT_AUTHORITY_URI;
...
public class DurationsContract {
    ...
    public static class Columns {
        ...
        Columns(){
            // prevent from instantiating instances
        }

        public static final String _ID = "Timings._id";
